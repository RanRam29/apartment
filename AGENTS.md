...
|------|-------------|--------|------------|
| T4 | State Machine v3 — new statuses, AgreementParty, AgreementRoom, OwnershipVerification | 🔴 TODO | — |
| T5 | Contract Upload + AI Extraction (Gemini OCR) | 🔴 TODO | T4 |
| T7 | Check-In Flow — photos per room + landlord confirm | 🔴 TODO | T5 |
| T10 | Check-Out Flow — photos, review rounds, auto-confirm | 🔴 TODO | T7 |
| T11 | Contract Renewal — PENDING_ACTIVATION state | 🔴 TODO | T5 |
...
| Task | Description | Status | Depends On |
|------|-------------|--------|------------|
| T2 | Notification System v2 — Resend Email + unified notify service | 🟢 DONE | — |
| T3 | Terms of Service — middleware + acceptance endpoint | 🟢 DONE | — |
| T6 | KYC v2 — Persona abstraction, HMAC webhook, ID checksum | 🟢 DONE | T2 |
| T14 | Multi-tenant — role switch, blocking, account locking | 🟢 DONE | — |
| T12 | Maintenance Flow — tickets, invoices, midrag.co.il link | 🟢 DONE | T2 |
| T13 | Guarantor Web Flow — invite, web SPA, Persona Web SDK | 🟢 DONE | T2, T6 |
| T17 | Mobile Screens — all new screens + Zustand stores | 🟢 DONE | T2 |
