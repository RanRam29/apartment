...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: colorsV3.background },
  carouselSlide: { width: SCREEN_WIDTH, height: 380, backgroundColor: colorsV3.surfaceContainer, justifyContent: 'center', alignItems: 'center' },
  ...
  luxuryBadge: {
    ...
    backgroundColor: '#FFD700', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10,
  },
  luxuryBadgeText: { color: colorsV3.primary, fontSize: 11, fontWeight: '700', fontFamily: fontFamily.bold },
  ctaBar: {
    position: 'absolute', bottom: 0, left: 0, right: 0,
    flexDirection: 'row-reverse', alignItems: 'center', justifyContent: 'space-between',
    backgroundColor: '#ffffff', paddingHorizontal: 20, paddingVertical: 14,
    borderTopWidth: 1, borderTopColor: colorsV3.outlineVariant,
  },
  ctaPrice: { flexDirection: 'row', alignItems: 'baseline', gap: 3 },
  ctaPriceAmount: { fontSize: 20, fontWeight: '800', color: colorsV3.primary, fontFamily: fontFamily.bold },
  ctaPriceLabel: { fontSize: 12, color: colorsV3.onSurfaceVariant, fontFamily: fontFamily.regular },
  ctaMainBtn: {
    flexDirection: 'row-reverse', alignItems: 'center', gap: 6,
    backgroundColor: colorsV3.actionCta, borderRadius: 24, // Pill shape
  ...
  ctaMainBtnText: { color: '#ffffff', fontWeight: '700', fontSize: 14, fontFamily: fontFamily.bold },
  carouselArrow: {
    position: 'absolute',
    top: 178,
    width: 34,
  ...
  noImagePlaceholder: { height: 200, justifyContent: 'center', alignItems: 'center', backgroundColor: colorsV3.surfaceContainer },
  floatingBack: {
    position: 'absolute', top: 16, left: 16,
  ...
  dot: { width: 8, height: 8, borderRadius: 4, backgroundColor: colorsV3.outlineVariant },
  dotActive: { backgroundColor: colorsV3.secondary, width: 20, borderRadius: 4 },
  content: { paddingVertical: 20 },
  titleRow: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 },
  price: { fontSize: 24, fontWeight: '800', color: colorsV3.primary, fontFamily: fontFamily.bold },
  verifiedBadge: { flexDirection: 'row-reverse', alignItems: 'center', gap: 4, backgroundColor: colorsV3.secondaryContainer, paddingHorizontal: 8, paddingVertical: 4, borderRadius: 8 },
  verifiedText: { color: colorsV3.onSecondaryContainer, fontSize: 12, fontWeight: '600', fontFamily: fontFamily.semibold },
  title: { fontSize: 18, fontWeight: '700', color: colorsV3.primary, textAlign: 'right', marginBottom: 6, fontFamily: fontFamily.bold },
  location: { fontSize: 14, color: colorsV3.onSurfaceVariant, textAlign: 'right', marginBottom: 16, fontFamily: fontFamily.regular },
  statsRow: { flexDirection: 'row-reverse', gap: 12, marginBottom: 20, flexWrap: 'wrap', justifyContent: 'flex-start' },
  stat: { flexDirection: 'row-reverse', alignItems: 'center', gap: 4, backgroundColor: '#ffffff', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, borderWidth: 1, borderColor: colorsV3.outlineVariant },
  statText: { color: colorsV3.onSurface, fontSize: 13, fontFamily: fontFamily.regular },
  sectionTitle: { fontSize: 15, fontWeight: '700', color: colorsV3.primary, textAlign: 'right', marginBottom: 10, marginTop: 4, fontFamily: fontFamily.bold },
  amenitiesWrap: { flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8, marginBottom: 20 },
  amenityChip: { backgroundColor: colorsV3.secondaryContainer, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 6, borderWidth: 1, borderColor: colorsV3.secondary },
  amenityText: { color: colorsV3.onSecondaryContainer, fontSize: 13, fontFamily: fontFamily.regular },
  description: { color: colorsV3.onSurface, fontSize: 14, lineHeight: 22, textAlign: 'right', marginBottom: 20, fontFamily: fontFamily.regular },
  landlordRow: { flexDirection: 'row-reverse', alignItems: 'center', gap: 10, marginBottom: 16, justifyContent: 'flex-start' },
  avatar: { width: 40, height: 40, borderRadius: 20 },
  avatarFallback: { backgroundColor: colorsV3.surfaceContainer, justifyContent: 'center', alignItems: 'center' },
  landlordName: { color: colorsV3.primary, fontSize: 14, fontWeight: '600', fontFamily: fontFamily.semibold },
  detailsWrap: { flexDirection: 'row-reverse', flexWrap: 'wrap', gap: 8, marginBottom: 20, justifyContent: 'flex-start' },
  detailChip: { flexDirection: 'row-reverse', alignItems: 'center', gap: 5, backgroundColor: '#ffffff', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 10, borderWidth: 1, borderColor: colorsV3.outlineVariant },
  detailChipText: { color: colorsV3.onSurfaceVariant, fontSize: 12, fontFamily: fontFamily.regular },
  ...
  errorText: { color: colorsV3.error, fontSize: 16, marginBottom: 16, fontFamily: fontFamily.regular },
  backBtn: { backgroundColor: colorsV3.actionCta, paddingHorizontal: 20, paddingVertical: 10, borderRadius: 10 },
  backBtnText: { color: '#ffffff', fontWeight: '700', fontFamily: fontFamily.bold },
  costCard: { backgroundColor: '#ffffff', borderRadius: 14, padding: 16, marginBottom: 20, borderWidth: 1, borderColor: colorsV3.outlineVariant },
  costRow: { flexDirection: 'row-reverse', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 6 },
  costLabel: { color: colorsV3.onSurfaceVariant, fontSize: 14, textAlign: 'right', fontFamily: fontFamily.regular },
  costLabelBold: { color: colorsV3.primary, fontWeight: '700', fontSize: 15, fontFamily: fontFamily.bold },
  costAmount: { color: colorsV3.onSurface, fontSize: 14, fontFamily: fontFamily.regular },
  costAmountBold: { color: colorsV3.secondary, fontWeight: '800', fontSize: 16, fontFamily: fontFamily.bold },
  costDivider: { height: 1, backgroundColor: colorsV3.outlineVariant, marginVertical: 8 },
  costNote: { color: colorsV3.onSurfaceVariant, fontSize: 11, textAlign: 'right', marginTop: 8, fontFamily: fontFamily.regular },
  trustBadgeMini: {
    paddingHorizontal: 6,
    paddingVertical: 2,
    borderRadius: 8,
