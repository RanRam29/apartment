...
const styles = StyleSheet.create({
  ...
  dotActive: { backgroundColor: C.navy, width: 20 },
  scroll: { padding: 24, paddingBottom: 40 },
  step: { alignItems: 'center', gap: 16 },
  emoji: { fontSize: 64, marginBottom: 4 },
  heading: { fontSize: 24, fontWeight: '800', color: C.text, textAlign: 'center' },
  body: { fontSize: 14, color: C.textSub, textAlign: 'center', lineHeight: 22 },
  ...
  skipText: { color: C.textSub, fontSize: 13 },
