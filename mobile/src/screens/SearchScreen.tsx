        ...
        <View style={styles.searchRow}>
          ...
          <View style={styles.inputWrap}>
            ...
            {(query.length > 0 || results.length > 0) && (
              <TouchableOpacity style={styles.clearBtn} onPress={clearSearch}>
                <Ionicons name="close-circle" size={18} color="#A0A0B2" />
              </TouchableOpacity>
            )}
          </View>
          <TouchableOpacity
          ...
          >
            <Ionicons
              name="options"
              size={20}
              color={showFilters || hasManualFilters ? '#fff' : '#A0A0B2'}
            />
          </TouchableOpacity>
        </View>
  ...
  return (
    <TouchableOpacity style={styles.resultCard} onPress={onPress} activeOpacity={0.85}>
      ...
      {apartment.landlord?.isVerified && (
        <Ionicons name="checkmark-circle" size={18} color="#6C5CE7" style={styles.verifiedIcon} />
      )}
      <Ionicons name="chevron-back" size={18} color="#A0A0B2" />
    </TouchableOpacity>
  );
}
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: '#A0A0B2', fontSize: 13, paddingHorizontal: 20, textAlign: 'right', marginBottom: 12 },
  ...
  searchInput: {
    ...
    color: '#fff', fontSize: 14, borderWidth: 1, borderColor: '#3A3A5E',
  },
  ...
  filterToggleBtnActive: { backgroundColor: '#6C5CE7', borderColor: '#6C5CE7' },
  ...
  filterLabel: { color: '#A0A0B2', fontSize: 11, fontWeight: '600', textAlign: 'right' },
  cityScroll: { flexGrow: 0 },
  chip: {
    paddingHorizontal: 12, paddingVertical: 6, borderRadius: 20,
    backgroundColor: '#1A1A2E', borderWidth: 1, borderColor: '#3A3A5E', marginRight: 6,
  },
  chipActive: { backgroundColor: 'rgba(108,92,231,0.25)', borderColor: '#6C5CE7' },
  chipText: { color: '#A0A0B2', fontSize: 12 },
  ...
  roomBtnActive: { backgroundColor: 'rgba(108,92,231,0.25)', borderColor: '#6C5CE7' },
  roomBtnText: { color: '#A0A0B2', fontSize: 13, fontWeight: '600' },
  roomBtnTextActive: { color: '#6C5CE7' },

  filterRow: { flexDirection: 'row', gap: 10, alignItems: 'flex-end' },
  priceInput: {
    backgroundColor: '#1A1A2E', borderRadius: 10,
    paddingHorizontal: 12, paddingVertical: 8,
    color: '#fff', fontSize: 13, borderWidth: 1, borderColor: '#3A3A5E', marginTop: 4,
  },
  petsBtn: {
  ...
  petsBtnActive: { backgroundColor: 'rgba(108,92,231,0.25)', borderColor: '#6C5CE7' },
  petsBtnText: { fontSize: 14 },
  petsBtnLabel: { color: '#A0A0B2', fontSize: 11 },
  petsBtnLabelActive: { color: '#6C5CE7' },
  clearFiltersBtn: { alignItems: 'flex-end' },
  clearFiltersText: { color: '#FF4757', fontSize: 12 },

  parsedRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, paddingHorizontal: 16, marginBottom: 8 },
  parsedChip: {
    backgroundColor: 'rgba(108,92,231,0.15)', borderRadius: 8,
    paddingHorizontal: 10, paddingVertical: 4, borderWidth: 1, borderColor: 'rgba(108,92,231,0.3)',
  },
  parsedChipText: { color: '#6C5CE7', fontSize: 11, fontWeight: '600' },

  suggestions: { padding: 16, gap: 8 },
  suggestionsLabel: { color: '#A0A0B2', fontSize: 12, textAlign: 'right', marginBottom: 4 },
  suggestionChip: {
    flexDirection: 'row', alignItems: 'center', gap: 8,
    backgroundColor: '#2A2A3E', borderRadius: 10, padding: 12, justifyContent: 'flex-end',
  },
  ...
  errorText: { color: '#A0A0B2', fontSize: 14, textAlign: 'center' },
  retryBtn: { backgroundColor: '#6C5CE7', borderRadius: 10, paddingHorizontal: 24, paddingVertical: 10 },
  ...
  resultCard: {
    ...
    backgroundColor: '#2A2A3E', borderRadius: 14, padding: 10, gap: 10,
  },
  resultThumb: { width: 68, height: 68, borderRadius: 10 },
  resultInfo: { flex: 1, gap: 2 },
  resultTitle: { color: '#fff', fontSize: 13, fontWeight: '600', textAlign: 'right' },
  resultMeta: { color: '#A0A0B2', fontSize: 11, textAlign: 'right' },
  resultPrice: { color: '#6C5CE7', fontSize: 13, fontWeight: '700', textAlign: 'right' },
  resultAmenities: { color: '#3A3A5E', fontSize: 10, textAlign: 'right' },
  ...
  noResultsSub: { fontSize: 13, color: '#A0A0B2' },
});
